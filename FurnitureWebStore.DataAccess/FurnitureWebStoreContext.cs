...
namespace FurnitureWebStore.DataAccess
{
    public partial class FurnitureWebStoreContext : DbContext
    {
        public FurnitureWebStoreContext()
        {
        }

        public FurnitureWebStoreContext(DbContextOptions<FurnitureWebStoreContext> options)
            : base(options)
        {
        }
